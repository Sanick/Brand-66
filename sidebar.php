<aside class="sidebar col-sm-4">
        <article class="about-us">
            <h1>Brand 66: Exploring Design</h1>
            <p>
                One small step for step for design blogs.
                Brand66 is on a mission to uncover design
                trends and examples of brilliant thinking,
                be they in distant lands or closer to home.
            </p>
        </article>
        <form action="#" method="post" class="form-blog">
            <p>Subscribe</p>
            <span>Brand66 delivered fresh to your inbox</span>
            <div class="email-wrapp">
                <input type="email" placeholder=" Email address" class="email"/>
                <button class="glyphicon glyphicon-ok submit"></button>
            </div>
        ...
        <form action="#" method="post" class="search-blog">
            ...
            <div class="search-wrapp">
                ...
                <button class="glyphicon glyphicon-arrow-right submit-search"></button>
            </div>
        </form>
</aside>